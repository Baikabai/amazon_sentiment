...
from data_preprocessing import clean_html,normalize_number,tokenize,tokenize_base_form
from utils import load_dataset,train_and_eval

def main():
    x,y = load_dataset("D:/baikabai/data_set/amazon/amazon_reviews_multilingual_JP_v1_00.tsv",n=1000)
